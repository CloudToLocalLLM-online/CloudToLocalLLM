...
main() {
    case "${1:-}" in
        ...
        "help"|"--help"|"-h"|"")
            ...
            echo "    â€¢ Hotfixes and critical bug fixes requiring immediate deployment"
            echo "    â€¢ Security updates and emergency patches"
            echo "    â€¢ Critical stability fixes that can't wait for next minor release"
            echo "    â€¢ Examples: Database connection fix, authentication bug, crash fix"
            echo ""
            echo "  MINOR (0.X.0+YYYYMMDDHHMM) - PLANNED FEATURES:"
            echo "    â€¢ Feature additions and new functionality"
            echo "    â€¢ Quality of life improvements and UI enhancements"
            echo "    â€¢ Planned feature releases and capability expansions"
            echo "    â€¢ Examples: New tunnel features, UI improvements, API additions"
            echo ""
            echo "  MAJOR (X.0.0+YYYYMMDDHHMM) - BREAKING CHANGES:"
            echo "    â€¢ Breaking changes and architectural overhauls"
            echo "    â€¢ Significant API changes requiring user adaptation"
            echo "    â€¢ Major platform or framework migrations"
            echo "    â€¢ Examples: Flutter 4.0 migration, API v2 breaking changes"
            echo "    â€¢ Creates GitHub release automatically"
            echo ""
            echo "  BUILD (X.Y.Z+YYYYMMDDHHMM) - TIMESTAMP ONLY:"
            echo "    â€¢ No semantic version change, only build timestamp update"
            echo "    â€¢ Used for CI/CD builds and testing iterations"
            echo ""
