...
case "${1:-}" in
    ...
    --help|-h)
        ...
        echo "  3. Deployment to VPS with Docker"
        echo "  4. Service startup verification"
        echo "  5. STRICT health checks (zero tolerance)"
        echo "  6. Cleanup on success (use Git for rollback if needed)"
        echo
        ...
        echo "  - Git version control for rollback capability"
        ...
        echo "  - Fail-fast on ANY warning or error"
        echo
        echo "STRICT SUCCESS CRITERIA:"
        echo "  - Zero warnings AND zero errors required"
