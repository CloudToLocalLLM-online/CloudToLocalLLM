...
### 📦 What's Included
- Windows Desktop Application (cloudtolocalllm-windows-3.11.15.zip) - Portable ZIP package
- Windows Installer (CloudToLocalLLM-Windows-3.11.15-Setup.exe) - Easy installation
