...
if (hasPermission(req.userRoles, [PERMISSIONS.VIEW_USERS, PERMISSIONS.EDIT_USERS])) {
...
```javascript
if (hasAnyPermission(req.userRoles, [PERMISSIONS.VIEW_USERS, PERMISSIONS.EDIT_USERS])) {
