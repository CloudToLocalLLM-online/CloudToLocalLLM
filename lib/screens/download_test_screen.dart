              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildStatusRow('GitHub API', _isLoading ? 'Checking...' : (_error == null ? 'Connected' : 'Error')),
                    if (_latestRelease != null) ...[
                      _buildStatusRow('Latest Version', _latestRelease!.tagName),
                      _buildStatusRow('Release Date', _formatDate(_latestRelease!.publishedAt)),
                      _buildStatusRow('Assets Available', '${_latestRelease!.assets.length}'),
                    ],
                  ],
                ),
              ),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildManualLink(
                      ...
                      'https://github.com/imrightguy/CloudToLocalLLM/releases',
                      Icons.open_in_new,
                    ),
                    _buildManualLink(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 8),
                      ..._latestRelease!.assets.map((asset) => Padding(
