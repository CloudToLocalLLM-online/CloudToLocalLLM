...
class CloudToLocalLLMVersions {
  ...
  static const String mainAppVersion = '3.14.36';
  static const int mainAppBuildNumber = 202507280351;

  // Tunnel manager version (integrated in v3.5.0+)
  static const String tunnelManagerVersion = '3.14.36';
  static const int tunnelManagerBuildNumber = 202507280351;

  // Shared library version
  static const String sharedLibraryVersion = '3.14.36';
  static const int sharedLibraryBuildNumber = 202507280351;
  ...
  static const String buildTimestamp = '2025-07-28T07:51:11Z';
