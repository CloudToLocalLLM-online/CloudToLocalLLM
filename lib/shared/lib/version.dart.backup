...
class CloudToLocalLLMVersions {
  ...
  static const String mainAppVersion = '3.12.10';
  static const int mainAppBuildNumber = 202507251624;

  // Tunnel manager version (integrated in v3.5.0+)
  static const String tunnelManagerVersion = '3.12.10';
  static const int tunnelManagerBuildNumber = 202507251624;

  // Shared library version
  static const String sharedLibraryVersion = '3.12.10';
  static const int sharedLibraryBuildNumber = 202507251624;
  ...
  static const String buildTimestamp = '2025-07-25T20:24:08Z';
