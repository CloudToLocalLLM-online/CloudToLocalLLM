...
class CloudToLocalLLMVersions {
  ...
  static const String mainAppVersion = '4.0.17';
  static const int mainAppBuildNumber = 202507301103;

  // Tunnel manager version (integrated in v3.5.0+)
  static const String tunnelManagerVersion = '4.0.17';
  static const int tunnelManagerBuildNumber = 202507301103;

  // Shared library version
  static const String sharedLibraryVersion = '4.0.17';
  static const int sharedLibraryBuildNumber = 202507301103;
  ...
  static const String buildTimestamp = '2025-07-30T15:03:19Z';
