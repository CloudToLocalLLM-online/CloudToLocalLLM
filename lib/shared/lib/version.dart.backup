...
class CloudToLocalLLMVersions {
  ...
  static const String mainAppVersion = '3.14.8';
  static const int mainAppBuildNumber = 202507270051;

  // Tunnel manager version (integrated in v3.5.0+)
  static const String tunnelManagerVersion = '3.14.8';
  static const int tunnelManagerBuildNumber = 202507270051;

  // Shared library version
  static const String sharedLibraryVersion = '3.14.8';
  static const int sharedLibraryBuildNumber = 202507270051;
  ...
  static const String buildTimestamp = '2025-07-27T04:51:56Z';
