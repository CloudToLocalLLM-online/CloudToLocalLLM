...
class CloudToLocalLLMVersions {
  ...
  static const String mainAppVersion = '3.14.38';
  static const int mainAppBuildNumber = 202507280404;

  // Tunnel manager version (integrated in v3.5.0+)
  static const String tunnelManagerVersion = '3.14.38';
  static const int tunnelManagerBuildNumber = 202507280404;

  // Shared library version
  static const String sharedLibraryVersion = '3.14.38';
  static const int sharedLibraryBuildNumber = 202507280404;
  ...
  static const String buildTimestamp = '2025-07-28T08:04:32Z';
