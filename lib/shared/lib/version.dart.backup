...
class CloudToLocalLLMVersions {
  ...
  static const String mainAppVersion = '4.0.40';
  static const int mainAppBuildNumber = 202508031635;

  // Tunnel manager version (integrated in v3.5.0+)
  static const String tunnelManagerVersion = '4.0.40';
  static const int tunnelManagerBuildNumber = 202508031635;

  // Shared library version
  static const String sharedLibraryVersion = '4.0.40';
  static const int sharedLibraryBuildNumber = 202508031635;
  ...
  static const String buildTimestamp = '2025-08-03T20:35:49Z';
