...
class CloudToLocalLLMVersions {
  ...
  static const String mainAppVersion = '3.14.50';
  static const int mainAppBuildNumber = 202507290121;

  // Tunnel manager version (integrated in v3.5.0+)
  static const String tunnelManagerVersion = '3.14.50';
  static const int tunnelManagerBuildNumber = 202507290121;

  // Shared library version
  static const String sharedLibraryVersion = '3.14.50';
  static const int sharedLibraryBuildNumber = 202507290121;
  ...
  static const String buildTimestamp = '2025-07-29T05:21:05Z';
