...
class CloudToLocalLLMVersions {
  ...
  static const String mainAppVersion = '3.12.12';
  static const int mainAppBuildNumber = 202507251917;

  // Tunnel manager version (integrated in v3.5.0+)
  static const String tunnelManagerVersion = '3.12.12';
  static const int tunnelManagerBuildNumber = 202507251917;

  // Shared library version
  static const String sharedLibraryVersion = '3.12.12';
  static const int sharedLibraryBuildNumber = 202507251917;
  ...
  static const String buildTimestamp = '2025-07-25T23:17:17Z';
