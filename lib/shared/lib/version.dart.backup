...
class CloudToLocalLLMVersions {
  ...
  static const String mainAppVersion = '3.14.18';
  static const int mainAppBuildNumber = 202507271855;

  // Tunnel manager version (integrated in v3.5.0+)
  static const String tunnelManagerVersion = '3.14.18';
  static const int tunnelManagerBuildNumber = 202507271855;

  // Shared library version
  static const String sharedLibraryVersion = '3.14.18';
  static const int sharedLibraryBuildNumber = 202507271855;
  ...
  static const String buildTimestamp = '2025-07-27T22:55:42Z';
