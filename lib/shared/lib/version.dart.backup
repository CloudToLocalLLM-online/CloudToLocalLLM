...
class CloudToLocalLLMVersions {
  ...
  static const String mainAppVersion = '4.0.33';
  static const int mainAppBuildNumber = 202508021113;

  // Tunnel manager version (integrated in v3.5.0+)
  static const String tunnelManagerVersion = '4.0.33';
  static const int tunnelManagerBuildNumber = 202508021113;

  // Shared library version
  static const String sharedLibraryVersion = '4.0.33';
  static const int sharedLibraryBuildNumber = 202508021113;
  ...
  static const String buildTimestamp = '2025-08-02T15:13:32Z';
