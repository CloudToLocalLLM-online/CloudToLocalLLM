...
class CloudToLocalLLMVersions {
  ...
  static const String mainAppVersion = '4.0.41';
  static const int mainAppBuildNumber = 202508031637;

  // Tunnel manager version (integrated in v3.5.0+)
  static const String tunnelManagerVersion = '4.0.41';
  static const int tunnelManagerBuildNumber = 202508031637;

  // Shared library version
  static const String sharedLibraryVersion = '4.0.41';
  static const int sharedLibraryBuildNumber = 202508031637;
  ...
  static const String buildTimestamp = '2025-08-03T20:37:08Z';
