...
class CloudToLocalLLMVersions {
  ...
  static const String mainAppVersion = '3.11.11';
  static const int mainAppBuildNumber = 202507242145;

  // Tunnel manager version (integrated in v3.5.0+)
  static const String tunnelManagerVersion = '3.11.11';
  static const int tunnelManagerBuildNumber = 202507242145;

  // Shared library version
  static const String sharedLibraryVersion = '3.11.11';
  static const int sharedLibraryBuildNumber = 202507242145;
  ...
  static const String buildTimestamp = '2025-07-25T01:45:37Z';
