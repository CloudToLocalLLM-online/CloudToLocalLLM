...
class CloudToLocalLLMVersions {
  ...
  static const String mainAppVersion = '3.14.14';
  static const int mainAppBuildNumber = 202507270246;

  // Tunnel manager version (integrated in v3.5.0+)
  static const String tunnelManagerVersion = '3.14.14';
  static const int tunnelManagerBuildNumber = 202507270246;

  // Shared library version
  static const String sharedLibraryVersion = '3.14.14';
  static const int sharedLibraryBuildNumber = 202507270246;
  ...
  static const String buildTimestamp = '2025-07-27T06:46:16Z';
