...
class CloudToLocalLLMVersions {
  ...
  static const String mainAppVersion = '3.14.47';
  static const int mainAppBuildNumber = 202507282125;

  // Tunnel manager version (integrated in v3.5.0+)
  static const String tunnelManagerVersion = '3.14.47';
  static const int tunnelManagerBuildNumber = 202507282125;

  // Shared library version
  static const String sharedLibraryVersion = '3.14.47';
  static const int sharedLibraryBuildNumber = 202507282125;
  ...
  static const String buildTimestamp = '2025-07-29T01:25:52Z';
