...
class CloudToLocalLLMVersions {
  ...
  static const String mainAppVersion = '3.14.62';
  static const int mainAppBuildNumber = 202507291715;

  // Tunnel manager version (integrated in v3.5.0+)
  static const String tunnelManagerVersion = '3.14.62';
  static const int tunnelManagerBuildNumber = 202507291715;

  // Shared library version
  static const String sharedLibraryVersion = '3.14.62';
  static const int sharedLibraryBuildNumber = 202507291715;
  ...
  static const String buildTimestamp = '2025-07-29T21:15:30Z';
