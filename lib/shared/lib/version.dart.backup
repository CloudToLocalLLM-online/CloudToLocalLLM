...
class CloudToLocalLLMVersions {
  ...
  static const String mainAppVersion = '3.14.74';
  static const int mainAppBuildNumber = 202507292116;

  // Tunnel manager version (integrated in v3.5.0+)
  static const String tunnelManagerVersion = '3.14.74';
  static const int tunnelManagerBuildNumber = 202507292116;

  // Shared library version
  static const String sharedLibraryVersion = '3.14.74';
  static const int sharedLibraryBuildNumber = 202507292116;
  ...
  static const String buildTimestamp = '2025-07-30T01:16:48Z';
