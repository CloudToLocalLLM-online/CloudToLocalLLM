...
class CloudToLocalLLMVersions {
  ...
  static const String mainAppVersion = '3.14.65';
  static const int mainAppBuildNumber = 202507291736;

  // Tunnel manager version (integrated in v3.5.0+)
  static const String tunnelManagerVersion = '3.14.65';
  static const int tunnelManagerBuildNumber = 202507291736;

  // Shared library version
  static const String sharedLibraryVersion = '3.14.65';
  static const int sharedLibraryBuildNumber = 202507291736;
  ...
  static const String buildTimestamp = '2025-07-29T21:36:33Z';
