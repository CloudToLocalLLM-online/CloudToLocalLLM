...
class CloudToLocalLLMVersions {
  ...
  static const String mainAppVersion = '4.0.9';
  static const int mainAppBuildNumber = 202507300312;

  // Tunnel manager version (integrated in v3.5.0+)
  static const String tunnelManagerVersion = '4.0.9';
  static const int tunnelManagerBuildNumber = 202507300312;

  // Shared library version
  static const String sharedLibraryVersion = '4.0.9';
  static const int sharedLibraryBuildNumber = 202507300312;
  ...
  static const String buildTimestamp = '2025-07-30T07:12:30Z';
