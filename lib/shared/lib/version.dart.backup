...
class CloudToLocalLLMVersions {
  ...
  static const String mainAppVersion = '3.14.44';
  static const int mainAppBuildNumber = 202507281402;

  // Tunnel manager version (integrated in v3.5.0+)
  static const String tunnelManagerVersion = '3.14.44';
  static const int tunnelManagerBuildNumber = 202507281402;

  // Shared library version
  static const String sharedLibraryVersion = '3.14.44';
  static const int sharedLibraryBuildNumber = 202507281402;
  ...
  static const String buildTimestamp = '2025-07-28T18:02:17Z';
