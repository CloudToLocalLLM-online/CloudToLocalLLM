...
class CloudToLocalLLMVersions {
  ...
  static const String mainAppVersion = '4.0.23';
  static const int mainAppBuildNumber = 202507310627;

  // Tunnel manager version (integrated in v3.5.0+)
  static const String tunnelManagerVersion = '4.0.23';
  static const int tunnelManagerBuildNumber = 202507310627;

  // Shared library version
  static const String sharedLibraryVersion = '4.0.23';
  static const int sharedLibraryBuildNumber = 202507310627;
  ...
  static const String buildTimestamp = '2025-07-31T10:27:34Z';
