...
class CloudToLocalLLMVersions {
  ...
  static const String mainAppVersion = '3.14.29';
  static const int mainAppBuildNumber = 202507272230;

  // Tunnel manager version (integrated in v3.5.0+)
  static const String tunnelManagerVersion = '3.14.29';
  static const int tunnelManagerBuildNumber = 202507272230;

  // Shared library version
  static const String sharedLibraryVersion = '3.14.29';
  static const int sharedLibraryBuildNumber = 202507272230;
  ...
  static const String buildTimestamp = '2025-07-28T02:30:08Z';
