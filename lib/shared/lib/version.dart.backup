...
class CloudToLocalLLMVersions {
  ...
  static const String mainAppVersion = '3.14.17';
  static const int mainAppBuildNumber = 202507271254;

  // Tunnel manager version (integrated in v3.5.0+)
  static const String tunnelManagerVersion = '3.14.17';
  static const int tunnelManagerBuildNumber = 202507271254;

  // Shared library version
  static const String sharedLibraryVersion = '3.14.17';
  static const int sharedLibraryBuildNumber = 202507271254;
  ...
  static const String buildTimestamp = '2025-07-27T16:54:37Z';
