...
class CloudToLocalLLMVersions {
  ...
  static const String mainAppVersion = '3.11.15';
  static const int mainAppBuildNumber = 202507242203;

  // Tunnel manager version (integrated in v3.5.0+)
  static const String tunnelManagerVersion = '3.11.15';
  static const int tunnelManagerBuildNumber = 202507242203;

  // Shared library version
  static const String sharedLibraryVersion = '3.11.15';
  static const int sharedLibraryBuildNumber = 202507242203;
  ...
  static const String buildTimestamp = '2025-07-25T02:03:21Z';
