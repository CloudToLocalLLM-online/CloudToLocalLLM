...
class CloudToLocalLLMVersions {
  ...
  static const String mainAppVersion = '3.13.0';
  static const int mainAppBuildNumber = 202507262156;

  // Tunnel manager version (integrated in v3.5.0+)
  static const String tunnelManagerVersion = '3.13.0';
  static const int tunnelManagerBuildNumber = 202507262156;

  // Shared library version
  static const String sharedLibraryVersion = '3.13.0';
  static const int sharedLibraryBuildNumber = 202507262156;
  ...
  static const String buildTimestamp = '2025-07-27T01:56:35Z';
