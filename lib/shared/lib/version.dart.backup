...
class CloudToLocalLLMVersions {
  ...
  static const String mainAppVersion = '4.0.46';
  static const int mainAppBuildNumber = 202508040000;

  // Tunnel manager version (integrated in v3.5.0+)
  static const String tunnelManagerVersion = '4.0.46';
  static const int tunnelManagerBuildNumber = 202508040000;

  // Shared library version
  static const String sharedLibraryVersion = '4.0.46';
  static const int sharedLibraryBuildNumber = 202508040000;
  ...
  static const String buildTimestamp = '2025-08-04T04:00:10Z';
