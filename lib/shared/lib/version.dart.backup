...
class CloudToLocalLLMVersions {
  ...
  static const String mainAppVersion = '3.14.31';
  static const int mainAppBuildNumber = 202507280243;

  // Tunnel manager version (integrated in v3.5.0+)
  static const String tunnelManagerVersion = '3.14.31';
  static const int tunnelManagerBuildNumber = 202507280243;

  // Shared library version
  static const String sharedLibraryVersion = '3.14.31';
  static const int sharedLibraryBuildNumber = 202507280243;
  ...
  static const String buildTimestamp = '2025-07-28T06:43:05Z';
