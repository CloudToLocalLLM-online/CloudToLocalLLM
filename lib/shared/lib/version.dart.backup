...
class CloudToLocalLLMVersions {
  ...
  static const String mainAppVersion = '4.0.35';
  static const int mainAppBuildNumber = 202508021116;

  // Tunnel manager version (integrated in v3.5.0+)
  static const String tunnelManagerVersion = '4.0.35';
  static const int tunnelManagerBuildNumber = 202508021116;

  // Shared library version
  static const String sharedLibraryVersion = '4.0.35';
  static const int sharedLibraryBuildNumber = 202508021116;
  ...
  static const String buildTimestamp = '2025-08-02T15:16:23Z';
