...
class CloudToLocalLLMVersions {
  ...
  static const String mainAppVersion = '4.0.47';
  static const int mainAppBuildNumber = 202508040021;

  // Tunnel manager version (integrated in v3.5.0+)
  static const String tunnelManagerVersion = '4.0.47';
  static const int tunnelManagerBuildNumber = 202508040021;

  // Shared library version
  static const String sharedLibraryVersion = '4.0.47';
  static const int sharedLibraryBuildNumber = 202508040021;
  ...
  static const String buildTimestamp = '2025-08-04T04:21:38Z';
