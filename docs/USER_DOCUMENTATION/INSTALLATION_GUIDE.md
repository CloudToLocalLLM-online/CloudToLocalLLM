...
This guide covers installation of CloudToLocalLLM v3.10.3+ with the Unified Flutter-Native Architecture. The application features integrated system tray functionality and requires no external daemon processes.

**Supported Platforms:**
- **Linux**: Static Package, Manual Build, AUR (temporarily unavailable)
...
```bash
# Using yay (recommended) - Currently unavailable
# yay -S cloudtolocalllm

# Using paru - Currently unavailable
# paru -S cloudtolocalllm

# Manual installation - Currently unavailable
# git clone https://aur.archlinux.org/cloudtolocalllm.git
# cd cloudtolocalllm
# makepkg -si
```

#### **Alternative for Arch Linux Users**
Use Method 2 (Static Package) or Method 3 (Manual Build) below.
...
wget https://cloudtolocalllm.online/download/cloudtolocalllm-3.10.3-x86_64.tar.gz

# Verify checksum (optional but recommended)
wget https://cloudtolocalllm.online/download/cloudtolocalllm-3.10.3-x86_64.tar.gz.sha256
sha256sum -c cloudtolocalllm-3.10.3-x86_64.tar.gz.sha256

# Extract the package
tar -xzf cloudtolocalllm-3.10.3-x86_64.tar.gz

# Move to installation directory
sudo mv cloudtolocalllm-3.10.3-x86_64 /opt/cloudtolocalllm
...
wget https://github.com/imrightguy/CloudToLocalLLM/releases/download/v3.10.3/cloudtolocalllm_3.10.3_amd64.deb

# Install the package
sudo dpkg -i cloudtolocalllm_3.10.3_amd64.deb
...
# Expected output: CloudToLocalLLM v3.10.3+202507111702
