...
# Note: AUR scripts temporarily removed - see docs/DEPLOYMENT/AUR_STATUS.md
...
- `./scripts/build_unified_package.sh` - Create unified distribution package
- `./scripts/deploy/complete_deployment.sh` - Complete deployment workflow

### Deployment
- `./scripts/deploy/update_and_deploy.sh` - Lightweight VPS deployment
- `./scripts/deploy/complete_deployment.sh` - Enhanced deployment with advanced options (--verbose, --dry-run, --force)

### Temporarily Removed
- **AUR scripts** - Temporarily removed (reintegration planned). See [AUR Status](./AUR_STATUS.md) for details.
