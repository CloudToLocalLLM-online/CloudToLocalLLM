...
var aadOauth = (function () {
  ...
  function init(config) {
    ...
    var authData = {
      ...
      clientId: config.clientId,
      authority: config.customDomainUrl ? config.customDomainUrl : (config.isB2C ? "https://" + config.tenant + ".b2clogin.com/tfp/" + config.tenant + ".onmicrosoft.com/" + config.policy + "/" : "https://login.microsoftonline.com/" + config.tenant),
